...
int BRC_port = 10002;
int BRC_WebBodySize = 16200;

String[] BRC_ids = new String[] {"cameraOn","fileName","init","object","faceRecognition","brightness","adjustBrightness","filter","thresholdValue","blurValue","adaptiveBlockSize","adaptiveConstant","imageFilter","findContours","contourThreshold","filterType","findEdges","findLines","findLinesThreshold","findLinesMinLength","findLinesMaxLineGap","imageSource","movie","mediaType","backgroundSubtraction","colorChannels"};
String[] BRC_values = new String[] {"false","","0","face","0","50","0","t","80","50","50","50","0","0","80","canny","0","0","100","30","20","M","street","movie","0","0"};
...
+ "[\"RANGE\",\"brc_26\",\"contourThreshold\",\"brc_27\"],\n"
+ "[\"NOTE\",\"brc_28\",\"nt7\"],\n"
+ "[\"DROPDOWN\",\"brc_29\",\"filterType\"],\n"
+ "[\"BUTTON\",\"brc_30\",\"findEdges\"],\n"
+ "[\"NOTE\",\"brc_31\",\"nt8\"],\n"
+ "[\"BUTTON\",\"brc_32\",\"findLines\"],\n"
+ "[\"RANGE\",\"brc_33\",\"findLinesThreshold\",\"brc_34\"],\n"
+ "[\"RANGE\",\"brc_35\",\"findLinesMinLength\",\"brc_36\"],\n"
+ "[\"RANGE\",\"brc_37\",\"findLinesMaxLineGap\",\"brc_38\"],\n"
+ "[\"NOTE\",\"brc_39\",\"nt9\"],\n"
+ "[\"DROPDOWN\",\"brc_40\",\"imageSource\"],\n"
+ "[\"DROPDOWN\",\"brc_41\",\"movie\"],\n"
+ "[\"DROPDOWN\",\"brc_42\",\"mediaType\"],\n"
...
+ "\n"
+ " <table ><tr><td class=\"auto-style1\">1  \n"
+ "    <input type=\"range\" id=\"brc_26\" name=\"brc_26\" min=\"1\" max=\"255\" value=\"80\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_26','brc_27','contourThreshold');\" />  255<br/>\n"
+ "    Contour Threshold: <label id=\"brc_27\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table><tr><td class=\"auto-style1\"><label id=\"brc_28\">Edge Finder</label></td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">Filter Type:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_29\" id=\"brc_29\" onchange=\"SendNameValue('filterType='+document.brc.brc_29.value);\">\n"
...
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table><tr><td class=\"auto-style1\"><label id=\"brc_31\">Find Lines using Hough line Detection</label></td></tr></table>\n"
+ "\n"
+ "<input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Find Lines\" onClick=\"SendNameValue('findLines='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table ><tr><td class=\"auto-style1\">1  \n"
+ "    <input type=\"range\" id=\"brc_33\" name=\"brc_33\" min=\"1\" max=\"255\" value=\"100\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_33','brc_34','findLinesThreshold');\" />  255<br/>\n"
+ "    Threshold: <label id=\"brc_34\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">10  \n"
+ "    <input type=\"range\" id=\"brc_35\" name=\"brc_35\" min=\"10\" max=\"100\" value=\"30\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_35','brc_36','findLinesMinLength');\" />  100<br/>\n"
+ "    Minimum Length: <label id=\"brc_36\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">10  \n"
+ "    <input type=\"range\" id=\"brc_37\" name=\"brc_37\" min=\"10\" max=\"100\" value=\"20\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_37','brc_38','findLinesMaxLineGap');\" />  100<br/>\n"
+ "    Maximum Line Gap: <label id=\"brc_38\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table><tr><td class=\"auto-style1\"><label id=\"brc_39\">Background Subtraction</label></td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">Image Source for Background Subtraction:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_40\" id=\"brc_40\" onchange=\"SendNameValue('imageSource='+document.brc.brc_40.value);\">\n"
...
+ "<select name=\"brc_41\" id=\"brc_41\" onchange=\"SendNameValue('movie='+document.brc.brc_41.value);\">\n"
...
+ "<select name=\"brc_42\" id=\"brc_42\" onchange=\"SendNameValue('mediaType='+document.brc.brc_42.value);\">\n"
