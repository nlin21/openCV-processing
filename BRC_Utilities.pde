...
int BRC_port = 10002;
int BRC_WebBodySize = 16982;

String[] BRC_ids = new String[] {"cameraOn","fileName","init","object","faceRecognition","brightness","adjustBrightness","contrast","adjustContrast","filter","thresholdValue","blurValue","adaptiveBlockSize","adaptiveConstant","imageFilter","findContours","contourThreshold","filterType","findEdges","findLines","findLinesThreshold","findLinesMinLength","findLinesMaxLineGap","imageSource","movie","mediaType","backgroundSubtraction","colorChannels"};
String[] BRC_values = new String[] {"false","","0","face","0","50","0","0","0","t","80","50","50","50","0","0","80","canny","0","0","100","30","20","M","street","movie","0","0"};
...
+ "[\"NOTE\",\"brc_26\",\"nt5\"],\n"
+ "[\"BUTTON\",\"brc_27\",\"imageFilter\"],\n"
+ "[\"NOTE\",\"brc_28\",\"nt6\"],\n"
+ "[\"BUTTON\",\"brc_29\",\"findContours\"],\n"
+ "[\"RANGE\",\"brc_30\",\"contourThreshold\",\"brc_31\"],\n"
+ "[\"NOTE\",\"brc_32\",\"nt7\"],\n"
+ "[\"DROPDOWN\",\"brc_33\",\"filterType\"],\n"
+ "[\"BUTTON\",\"brc_34\",\"findEdges\"],\n"
+ "[\"NOTE\",\"brc_35\",\"nt8\"],\n"
+ "[\"BUTTON\",\"brc_36\",\"findLines\"],\n"
+ "[\"RANGE\",\"brc_37\",\"findLinesThreshold\",\"brc_38\"],\n"
+ "[\"RANGE\",\"brc_39\",\"findLinesMinLength\",\"brc_40\"],\n"
+ "[\"RANGE\",\"brc_41\",\"findLinesMaxLineGap\",\"brc_42\"],\n"
+ "[\"NOTE\",\"brc_43\",\"nt9\"],\n"
+ "[\"DROPDOWN\",\"brc_44\",\"imageSource\"],\n"
+ "[\"DROPDOWN\",\"brc_45\",\"movie\"],\n"
+ "[\"DROPDOWN\",\"brc_46\",\"mediaType\"],\n"
+ "[\"BUTTON\",\"brc_47\",\"backgroundSubtraction\"],\n"
+ "[\"NOTE\",\"brc_48\",\"nt10\"],\n"
+ "[\"BUTTON\",\"brc_49\",\"colorChannels\"]];\n"
+ "\n"
+ "Monitor = false;\n"
+ "\n"
+ "function Sendall() {\n"
...
+ "    <input type=\"range\" id=\"brc_13\" name=\"brc_13\" min=\"0\" max=\"200\" value=\"0\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_13','brc_14','contrast');\" />  200<br/>\n"
...
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">1  \n"
+ "    <input type=\"range\" id=\"brc_22\" name=\"brc_22\" min=\"1\" max=\"255\" value=\"50\" step=\"1\"\n"
...
+ "    </td></tr></table>\n"
+ "\n"
+ "<table><tr><td class=\"auto-style1\"><label id=\"brc_26\">Image Filtering</label></td></tr></table>\n"
+ "\n"
+ "<input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Image Filter\" onClick=\"SendNameValue('imageFilter='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table><tr><td class=\"auto-style1\"><label id=\"brc_28\">Finding Contours</label></td></tr></table>\n"
+ "\n"
+ "<input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Find Contours\" onClick=\"SendNameValue('findContours='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table ><tr><td class=\"auto-style1\">1  \n"
+ "    <input type=\"range\" id=\"brc_30\" name=\"brc_30\" min=\"1\" max=\"255\" value=\"80\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_30','brc_31','contourThreshold');\" />  255<br/>\n"
+ "    Contour Threshold: <label id=\"brc_31\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table><tr><td class=\"auto-style1\"><label id=\"brc_32\">Edge Finder</label></td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">Filter Type:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_33\" id=\"brc_33\" onchange=\"SendNameValue('filterType='+document.brc.brc_33.value);\">\n"
...
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table><tr><td class=\"auto-style1\"><label id=\"brc_35\">Find Lines using Hough line Detection</label></td></tr></table>\n"
+ "\n"
+ "<input type=\"button\" name=\"<!--<id>-->\" id=\"<!--<id>-->\" value=\"Find Lines\" onClick=\"SendNameValue('findLines='+Math.floor(Math.random()*1000000));\" />\n"
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table ><tr><td class=\"auto-style1\">1  \n"
+ "    <input type=\"range\" id=\"brc_37\" name=\"brc_37\" min=\"1\" max=\"255\" value=\"100\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_37','brc_38','findLinesThreshold');\" />  255<br/>\n"
+ "    Threshold: <label id=\"brc_38\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">10  \n"
+ "    <input type=\"range\" id=\"brc_39\" name=\"brc_39\" min=\"10\" max=\"100\" value=\"30\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_39','brc_40','findLinesMinLength');\" />  100<br/>\n"
+ "    Minimum Length: <label id=\"brc_40\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">10  \n"
+ "    <input type=\"range\" id=\"brc_41\" name=\"brc_41\" min=\"10\" max=\"100\" value=\"20\" step=\"1\"\n"
+ "    oninput=\"ShowRange('brc_41','brc_42','findLinesMaxLineGap');\" />  100<br/>\n"
+ "    Maximum Line Gap: <label id=\"brc_42\"></label>\n"
+ "    </td></tr></table>\n"
+ "\n"
...
+ "<select name=\"brc_45\" id=\"brc_45\" onchange=\"SendNameValue('movie='+document.brc.brc_45.value);\">\n"
+ "<option selected=\"selected\" value=\"street\">street movie</option>\n"
+ "<option  value=\"sampleMovie\">Sample Movie</option>\n"
+ "</select></td></tr></table>\n"
+ "\n"
+ "<table ><tr><td class=\"auto-style1\">Media Type:&nbsp;&nbsp;&nbsp;\n"
+ "<select name=\"brc_46\" id=\"brc_46\" onchange=\"SendNameValue('mediaType='+document.brc.brc_46.value);\">\n"
+ "<option selected=\"selected\" value=\"movie\">Movie</option>\n"
...
+ "&nbsp;&nbsp;&nbsp;\n"
+ "\n"
+ " <table><tr><td class=\"auto-style1\"><label id=\"brc_48\">Color Channeling</label></td></tr></table>\n"
+ "\n"
